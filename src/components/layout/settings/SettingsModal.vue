            ...
            >
              ...
              <div class="border-t border-gray-200 pt-4 space-y-4">
                ...
                <div>
                  <div class="flex items-center justify-between">
                    <div class="font-medium text-gray-900">
                      {{ t("settings.autoOpenVariablesPanelOnTemplateSelect") }}
                    </div>
                    <button
                      @click="designerStore.setAutoOpenVariablesPanelOnTemplateSelect(!designerStore.autoOpenVariablesPanelOnTemplateSelect)"
                      class="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
                      :class="
                        designerStore.autoOpenVariablesPanelOnTemplateSelect
                          ? 'bg-blue-600'
                          : 'bg-gray-200'
                      "
                    >
                  ...
                  <p class="text-xs text-gray-500 mt-2">
                    {{ t("settings.autoOpenVariablesPanelOnTemplateSelectDesc") }}
                  </p>
                </div>
