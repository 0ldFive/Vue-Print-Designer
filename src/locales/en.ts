export default {
  ...
  settings: {
    ...
    printModeLocal: 'Local Print',
    printModeRemote: 'Remote Print',
    ...
    silentPrintDesc: 'When enabled, skip the print dialog and use stored defaults.',
  ...
  printDialog: {
    title: 'Print Options',
    titleLocal: 'Local Print Options',
