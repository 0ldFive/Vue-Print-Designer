export default {
  ...
  properties: {
    ...
    help: {
      ...
      items: {
        ...
        tableFooterVariable:
          "表脚行变量 ＠footer 可动态提供表脚行；双击表脚单元格可编辑显示文本和变量字段。",
    ...
    label: {
      ...
      deleteColumn: "删除列",
      inferColumns: "从数据推断列",
      noColumns: "暂无列，点击下方按钮添加",
      visualMode: "可视化编辑",
      jsonMode: "JSON 编辑",
      columnsJsonNotArray: "JSON 内容必须是列数组",
      columnsJsonSynced: "JSON 有效时自动同步到列",
      footerRowIndex: "第 {n} 行",
      addFooterRow: "添加行",
      duplicateFooterRow: "复制行",
      deleteFooterRow: "删除行",
      footerRowMoveUp: "上移行",
      footerRowMoveDown: "下移行",
      noFooterRows: "暂无表脚行，点击下方按钮添加",
      footerCellText: "显示文本",
      footerCellVariable: "变量字段",
      footerRowsJsonNotArray: "JSON 内容必须是表脚行数组",
      footerRowsJsonSynced: "JSON 有效时自动同步到表脚行",
      selectCell: "选择单元格",
      selectedCellsCount: "已选 {n} 格",
      clearSelection: "清空选择",
      headerHeight: "表头高度",
      rowHeight: "行高",
      footerHeight: "表脚高度",
  ...
  toast: {
    ...
    columnsInferred: "已从数据新增 {n} 列",
    columnsInferNoData: "未找到可推断的数据行",
    columnsInferNoNew: "数据中的字段均已存在",
  },
  statusBar: {
    ready: "就绪",
    dragging: "移动中",
