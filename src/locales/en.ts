export default {
  ...
  editor: {
    ...
    multiLabelSettings: "Multi-label Layout Settings",
    multiLabelEnable: "Enable Multi-label Layout",
    multiLabelEnableHint:
      "Use the elements inside the first label as a template, then batch-arrange and print them from a data array.",
    multiLabelLayout: "Layout",
    multiLabelData: "Data Binding",
    multiLabelStyle: "Label Style",
    multiLabelPreview: "Layout Preview",
    multiLabelDataVariable: "Data Variable",
    multiLabelDataVariableHint:
      "Bind an array variable. Each array item maps to one label; its properties must match the label element variables one to one.",
    multiLabelDataVariablePlaceholder: "@labels",
    multiLabelRows: "Rows",
    multiLabelCols: "Columns",
    multiLabelDirection: "Order",
    multiLabelDirectionRow: "Horizontal (left to right, row by row)",
    multiLabelDirectionColumn: "Vertical (top to bottom, column by column)",
    multiLabelLabelWidth: "Label Width",
    multiLabelLabelHeight: "Label Height",
    multiLabelGapX: "Horizontal Gap",
    multiLabelGapY: "Vertical Gap",
    multiLabelMarginLeft: "Left Margin",
    multiLabelMarginTop: "Top Margin",
    multiLabelBackgroundColor: "Background",
    multiLabelBorderStyle: "Border Style",
    multiLabelBorderWidth: "Border Width",
    multiLabelBorderColor: "Border Color",
    multiLabelBorderNone: "No Border",
    multiLabelPerPage: "{count} labels per page",
    multiLabelTotalHint: "{total} labels · {pages} pages",
    multiLabelDragHint: "Drag the blue label frame to move the whole layout",
    multiLabelGhostHint: "Gray cells are placeholders; printed from data",
    multiLabelEmptyHint:
      "Place text / barcode / QR code / shapes inside the first label frame as a template",
    multiLabelNoData: "No data bound; preview fills the page with the current template",
  ...
  properties: {
    ...
    help: {
      ...
      items: {
        ...
        tableFooterVariable:
          "Footer row variable ＠footer can provide footer rows; double-click footer cells to edit display text and variable field.",
    ...
    label: {
      ...
      footerDataVariable: "Footer Row Variable",
      ...
      columnAdvanced: "More Settings",
      expandEditor: "Expand Editor",
      columnVisible: "Visible",
      columnMoveUp: "Move Up",
      columnMoveDown: "Move Down",
      addColumn: "Add Column",
      equalColumnWidths: "Distribute Evenly",
      duplicateColumn: "Duplicate Column",
      deleteColumn: "Delete Column",
      inferColumns: "Infer Columns from Data",
      noColumns: "No columns yet, click the button below to add",
      visualMode: "Visual Editor",
      jsonMode: "JSON Editor",
      columnsJsonNotArray: "JSON must be an array of columns",
      columnsJsonSynced: "Valid JSON syncs to columns automatically",
      footerRowIndex: "Row {n}",
      addFooterRow: "Add Row",
      duplicateFooterRow: "Duplicate Row",
      deleteFooterRow: "Delete Row",
      footerRowMoveUp: "Move Row Up",
      footerRowMoveDown: "Move Row Down",
      noFooterRows: "No footer rows yet, click the button below to add",
      footerCellText: "Display Text",
      footerCellVariable: "Variable Field",
      footerRowsJsonNotArray: "JSON must be an array of footer rows",
      footerRowsJsonSynced: "Valid JSON syncs to footer rows automatically",
      selectCell: "Select Cell",
      selectedCellsCount: "{n} cell(s) selected",
  ...
  settings: {
    ...
    showStatusBarDesc: "Show the status bar at the bottom of the editor.",
  ...
  toast: {
    ...
    columnsInferred: "Added {n} columns from data",
    columnsInferNoData: "No data rows found for inference",
    columnsInferNoNew: "All fields in the data already exist",
  },
  statusBar: {
    ready: "Ready",
    dragging: "Moving",
    draggingElement: "{element} moving",
    draggingMultiple: "Moving ({n} elements)",
    resizing: "Resizing",
    resizingElement: "Resizing {element}",
    resizingMultiple: "Resizing ({n} elements)",
    rotating: "Rotating",
    rotatingElement: "Rotating {element}",
    rotatingMultiple: "Rotating ({n} elements)",
    zoom: "Zoom",
    template: {
      saving: "Template saving",
      saved: "Template saved",
      unsaved: "Template unsaved",
    },
    connection: {
      cloudConnected: "Cloud print connected",
      cloudDisconnected: "Cloud print disconnected",
    ...
    progress: {
      preparing: "Preparing",
      rendering: "Rendering",
      renderingPage: "Rendering {current}/{total}",
      saving: "Saving",
      printing: "Printing",
    },
  },
